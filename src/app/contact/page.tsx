            ...
            <div className="space-y-3 md:col-span-1 flex flex-col">
              <div className="border border-white/10 bg-white/[0.02] p-3 sm:p-5 rounded-2xl flex-shrink-0 shadow-lg">
                ...
                <div className="space-y-2 sm:space-y-4">
                  <a href="https://discord.gg/wgXgZ4BfbH" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-2 sm:p-3 rounded-xl bg-[#5865F2]/10 hover:bg-[#5865F2]/20 border border-[#5865F2]/20 transition-all group">
